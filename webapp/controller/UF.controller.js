sap.ui.define([
	...
	return Controller.extend("br.com.idxtecUF.controller.UF", {
		...
		filtraUf: function(oEvent){
			var sQuery = oEvent.getParameter("query");
			var oFilter = new Filter("Sigla", FilterOperator.Contains, sQuery);
			
			var aFilters = [
				oFilter
			];

			this.getView().byId("tableUF").getBinding("rows").filter(aFilters, "Application");
		},
